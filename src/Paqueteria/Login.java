...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(89, 28, 90, 90));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 209, -1, -1));
        getContentPane().add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 158, 140, -1));
        getContentPane().add(txtContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 204, 120, -1));
    ...
    private void entradaUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entradaUsuarioActionPerformed
        if (!txtContrasena.getText().isBlank() && !txtUsuario.getText().isBlank()) {
            if (nuevo.identificar(txtUsuario.getText(), txtContrasena.getText())) {
